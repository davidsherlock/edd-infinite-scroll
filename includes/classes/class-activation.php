<?php
/**
 * EDD Infinite Scroll Activation Handler
 *
 * @package     EDD\Infinite_Scroll\Classes\Activation
...
if ( ! class_exists( 'EDD_Infinite_Scroll_Activation' ) ) {
     ...
     * @since       1.0.0
     */
    class EDD_Infinite_Scroll_Activation {
        ...
        public function missing_edd_notice() {
            if( $this->has_edd ) {
                ...
                $link = '<a href="' . $url . '">' . __( 'activate it', 'edd-infinite-scroll' ) . '</a>';
            } else {
                ...
                $link = '<a href="' . $url . '">' . __( 'install it', 'edd-infinite-scroll' ) . '</a>';
            }

            echo '<div class="error"><p>' . $this->plugin_name . sprintf( __( ' requires Easy Digital Downloads! Please %s to continue!', 'edd-infinite-scroll' ), $link ) . '</p></div>';
        }
    }
}
